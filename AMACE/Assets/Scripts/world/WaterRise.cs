...
public class WaterRise : MonoBehaviour
{
    ...
    void Update()
    {
        if(waterRiseStart && !waterRiseFinish && !SoundManager.Instance.roomSource.isPlaying)
        {
            SoundManager.Instance.roomSource.PlayOneShot(SoundManager.Instance.waterSound);
        }
